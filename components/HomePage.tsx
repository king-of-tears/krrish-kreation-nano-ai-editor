...
const features = [
    ...
    {
        icon: <TrashIcon className="w-8 h-8 text-pink-400" />,
        title: 'Magic Eraser',
        description: 'Effortlessly remove unwanted objects, people, or text from your photos.'
    },
    {
        icon: <PaintBrushIcon className="w-8 h-8 text-pink-400" />,
        title: 'Artistic Styles',
        description: 'Transform your photos into paintings, sketches, and other artistic styles instantly.'
    },
    {
        icon: <ExpandIcon className="w-8 h-8 text-pink-400" />,
        title: 'Expand Canvas',
        description: 'Extend the boundaries of your photos. The AI will intelligently fill in the new space.'
    },
    {
        icon: <BrainCircuitIcon className="w-8 h-8 text-pink-400" />,
        title: 'Generate Variations',
        description: 'Create multiple different versions or styles from a single image and prompt.'
    }
]
...
export const HomePage: React.FC<HomePageProps> = ({ onStartEditing, onStartGenerating }) => {
  return (
    <main className="flex-1 w-full overflow-y-auto animate-fade-in">
            ...
            <div className="mt-12 w-full max-w-md space-y-4">
                ...
                >
                    <div className="flex items-center gap-6">
                        <div className="p-4 bg-gradient-to-br from-blue-600 to-blue-900 rounded-xl shadow-lg">
        ...
        {/* Features Section */}
        <section id="features-section" className="py-24 bg-gray-950/50">
